...
class DEQFlowDemo(nn.Module):
    ...
    def forward(
        self, image1, image2, flow_gt=None, valid=None, step_seq_loss=None, flow_init=None, cached_result=None, **kwargs
    ):
        ...
        if self.training:
            ...
            return (
                coords1 - coords0,
                flow_up,
                {"sradius": torch.zeros(1, device=z_star.device), "cached_result": (net, coords1 - coords0)},
            )
