...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--b_solver", default="broyden", type=str, choices=["anderson", "broyden"], help="backward solver to use"
    )
    ...
    parser.add_argument(
        "--eval_factor", type=float, default=1.5, help="factor to scale up the f_thres at test for better precision."
    )
