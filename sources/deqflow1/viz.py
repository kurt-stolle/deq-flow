...
from .utils import InputPadder, flow_viz, forward_interpolate, frame_utils


@torch.no_grad()
def sintel_visualization(
    model, split="test", warm_start=False, fixed_point_reuse=False, output_path="sintel_viz", **kwargs
):
