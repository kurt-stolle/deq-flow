...
def broyden(f, x0, threshold=50, eps=1e-3, stop_mode="rel", indexing=None, ls=False, name="unknown", **kwargs):
...
def anderson(
    f, x0, threshold=50, eps=1e-3, stop_mode="rel", indexing=None, m=6, lam=1e-4, beta=1.0, intercept=-1, **kwargs
):
