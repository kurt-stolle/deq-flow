...
def broyden(func, x0, threshold=50, eps=1e-3, stop_mode="rel", indexing=None, LBFGS_thres=None, ls=False, **kwargs):
...
def anderson(func, x0, threshold=50, eps=1e-3, stop_mode="rel", indexing=None, m=6, lam=1e-4, beta=1.0, **kwargs):
...
def naive_solver(f, x0, threshold=50, eps=1e-3, stop_mode="rel", indexing=None, return_final=True, **kwargs):
