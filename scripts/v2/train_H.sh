...
python -m deqflow2 --total_run 1 --start_run 1 --name deq-flow-H-naive-120k-C-36-6-1 \
...
python -m deqflow2 --total_run 1 --start_run 1 --name deq-flow-H-naive-120k-T-40-2-3 \
