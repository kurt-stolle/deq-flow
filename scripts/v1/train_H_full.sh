...
python -m deqflow1 --name deq-flow-H-chairs --stage chairs --validation chairs \
...
python -m deqflow1 --name deq-flow-H-things --stage things \
...
python -m deqflow1 --name deq-flow-H-sintel --stage sintel \
...
python -m deqflow1 --name deq-flow-H-kitti --stage kitti \
